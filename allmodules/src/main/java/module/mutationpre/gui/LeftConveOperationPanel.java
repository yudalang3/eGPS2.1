...
public class LeftConveOperationPanel extends JPanel {
	...
	final SimplestModuleController controller;

//	private JButton btnRamdonColor;
	
	
	public LeftConveOperationPanel(SimplestModuleController controller2) {
		super();
...
//		ColorIcon colorIcon = new ColorIcon(Color.bl);
